...
TransactionHistory::TransactionHistory(Superior::TransactionHistory *pimpl, QObject *parent)
...
QString TransactionHistory::writeCSV(quint32 accountIndex, QString out)
{
    ...
    QString fn = QString(QString("%1/superior-txs_%2.csv").arg(out, QString::number(now / 1000)));
